---
name: brand-auditor
description: Audits a codebase for Integra brand compliance — checks colors, fonts, logos, and design tokens against the canonical brand guide. Use PROACTIVELY when reviewing UI code or before merging frontend PRs.
model: sonnet
---
